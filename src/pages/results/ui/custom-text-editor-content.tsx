  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center'>
        <p className='flex items-center justify-center gap-[0.44rem] text-lg text-green-100 pc:gap-[0.42rem] pc:text-base pc:leading-normal'>
      ...
      <Input
        ...
        className='w-full placeholder:text-slate-300 pc:h-[2.4rem] pc:rounded-[0.36rem] pc:px-[0.42rem] pc:py-[0.17rem] pc:text-base pc:leading-[170%]'
        value={value}
        onChange={handleChange}
      />
      <Button
        disabled={!value}
        className='h-[3.125rem] py-[0.88rem] text-[1.125rem] pc:h-[2.5rem] pc:rounded-[0.31rem] pc:py-[0.84rem] pc:text-base'
        onClick={handleEdit}
      >
        수정하기
      </Button>

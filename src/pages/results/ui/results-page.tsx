  ...
  return (
    <ContentLayout className='pb-8 tab:pb-[2.625rem] pc:pb-[3.06rem]'>
      ...
      <div className='flex flex-col gap-2 overflow-auto pc:flex-row pc:gap-0'>
        ...
        {/* 맞춤법/문법 오류 */}
        <div className='flex max-h-[30.5rem] min-h-[30.5rem] w-full flex-1 flex-col rounded-lg border border-blue-500 bg-white px-5 pb-3.5 pt-[18px] tab:rounded-[1rem] tab:p-10 tab:pb-7 pc:max-h-[40.25rem] pc:rounded-bl-none pc:rounded-tl-none pc:border-none'>
